...
/**
 * Dropdown subheader component
 * Uses role="none" so it is skipped by menu item navigation
 */
const DropdownSubheader = <template>
  <li class="dropdown-menu__subheader" role="none" ...attributes>{{yield}}</li>
</template>;
 ...
 *
 * @component DDropdownMenu
 */
export default class DDropdownMenu extends Component {
  @action
  handleKeydown(event) {
